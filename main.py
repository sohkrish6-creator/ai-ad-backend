...
async def campaign_launch_kit(request: CampaignLaunchKitRequest):
    ...
    prompt = (
        ...
        "NATURALNESS RULE: concrete outcome or offer detail in H2/H3, not a vague promise.\n"
        ...
        "NATURALNESS RULE: Numbers must be realistic — if client count is unknown, say 'multiple clients' or omit, do NOT invent '30+' or '100+'. Proof headline must be specific to this business, not generic.\n"
        ...
        "NATURALNESS RULE: Urgency must be dateable — 'August: 3 slots left' works; 'Limited offer!' does not. Name a real consequence for this business/season.\n"
...
async def _mi_sections_overview_dna_timeline(company_name: str, research: dict) -> dict:
    ...
    user_msg = (
        ...
        "3. For ICONIC CAMPAIGNS: scan the ICONIC CAMPAIGNS block AND the Wikipedia article's "
        "advertising/marketing sections. Any named mascot, campaign, or tagline with a known launch year "
        "gets its OWN dedicated entry (e.g. 'Amul Girl mascot launched by daCunha Communications, 1966'). "
        "Name the campaign explicitly in the milestone field.\n"
